...
typedef enum {
	...
	SYN_COOKIE_SENT = 41,
	SYN_COOKIE_CONN_CREATED = 42,
	CONN_CREATED_SYN_ACK_TO_SND_BUFFER = 43,
	RCOV_SYN_ACK_TO_SND_BUFFER = 44,
	TCP_SIMULTANEOUS_OPEN = 45,
	INC_RST_CHALL_ACK_SENT = 46,
	INC_RST_CONN_DEAD = 47,
	TCP_SEG_PROCESSED = 60,
	...
	INVALID_RST_DROPPED = -423,
	TCP_ACK_OUT_OF_SYNC = -424,
